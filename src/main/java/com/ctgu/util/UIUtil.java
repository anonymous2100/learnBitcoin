...
public class UIUtil
{
	 ...
	 * <p>
	 * author by darcula@com.bulenkov see https://github.com/bulenkov/Darcula
	 *
	 * @return
	 */
	...
	{
		return "Darcula".equals(App.config.getTheme()) || "Darcula(Recommended)".equals(App.config.getTheme())
				|| "Flat Dark".equals(App.config.getTheme()) || "Flat Darcula".equals(App.config.getTheme())
