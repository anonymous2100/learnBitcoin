...
public class UpdateInfoDialog extends JDialog
{
	...
	public void setHtmlText(String htmlText)
	{
		...
		styleSheet.addRule("body{font-family:" + buttonOK.getFont().getName() + ";font-size:"
				+ buttonOK.getFont().getSize() + ";}");
	...
	private void setupUI()
	{
		...
		panel1.add(spacer2, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER,
				GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
