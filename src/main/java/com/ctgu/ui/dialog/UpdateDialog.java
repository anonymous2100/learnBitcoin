...
public class UpdateDialog extends JDialog
{
	...
	public UpdateDialog()
	{
		...
		buttonDownloadFromWeb.addActionListener(e -> {
			...
			try
			{
				desktop.browse(new URI("https://github.com/anonymous2100/learnBitcoin/releases"));
			}
	...
	public void downLoad(String newVersion)
	{
		...
		ThreadUtil.execute(() -> {
			String fileUrl = "https://github.com/anonymous2100/learnBitcoin/releases/learnBitcoin-" + newVersion + "-x64-Setup.exe";
			...
			File tempDir = new File(FileUtil.getTmpDirPath() + "learnBitcoin");
			if (!tempDir.exists())
			{
				tempDir.mkdirs();
			}
	...
	private void setupUI()
	{
		...
		panel2.add(buttonDownloadFromWeb,
		...
		panel3.add(progressBarDownload,
				new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
						GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0,
						false));
		statusLabel = new JLabel();
		statusLabel.setText("就绪");
		panel3.add(statusLabel, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
				GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final Spacer spacer2 = new Spacer();
		panel3.add(spacer2, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
				GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
		final Spacer spacer3 = new Spacer();
		panel3.add(spacer3, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
				GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
	}
