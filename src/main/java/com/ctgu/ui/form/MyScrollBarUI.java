...
public class MyScrollBarUI extends BasicScrollBarUI
{
	...
	{
		c.setPreferredSize(new Dimension(35, 0));
	...
	protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds)
	{
		...
		g.setColor(new Color(250, 249, 222));
	...
	// {
	// // 设置画笔
	// gp = new GradientPaint(0, 0, Color.RED, trackBounds.width, 0, new Color(80, 80, 80));
	// }
	...
	// // 绘制Track的边框
	// /*
	// * g2.setColor(new Color(175, 155, 95)); g2.drawRect(trackBounds.x, trackBounds.y, trackBounds.width - 1,
